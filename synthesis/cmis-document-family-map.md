...
- [broadcom-2025-mpi-metrics-feature](../sources/broadcom-2025-mpi-metrics-feature.md) - vendor-specific Broadcom MPI metrics note for optical dust detection using cAPI/firmware diagnostics, with CMIS/VDM exposure left to module-vendor policy.
