...
related: [sources/oif2026-057-01-i3cmci-draft, sources/oif2026-057-01-firmware-functional-design-authority-cmis-over-i3c, sources/mipi-i3c-basic-v1-1-1, ../comparisons/i3cmci-required-subset-vs-mipi-i3c-feature-set.md, management-communication-interface, register-access-layer]
...
The I3C-based Management Communication Interface, or I3CMCI, is a draft CMIS MCI variant based on the public MIPI I3C Basic family. The uploaded `MIPI I3C Basic v1.1.1` specification is the clearest public normative baseline in this vault, but the I3CMCI implementation baseline is only the subset of MIPI controller/target behavior required by I3CMCI.
...
In other words, `v1.1.1` is the captured baseline for this vault; `v1.2` is the external target version when we want the newest public recommendation. Do not treat the entire MIPI I3C feature set as required for I3CMCI. The required/not-required split is tracked in [i3cmci-required-subset-vs-mipi-i3c-feature-set](../comparisons/i3cmci-required-subset-vs-mipi-i3c-feature-set.md).
